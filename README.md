...
*CustomerApi* | [**add_customer**](docs/CustomerApi.md#add_customer) | **POST** /customers | 
*CustomerApi* | [**find_customer_by_id**](docs/CustomerApi.md#find_customer_by_id) | **GET** /customers/{id} | Find Customer by ID
*CustomerApi* | [**find_customers**](docs/CustomerApi.md#find_customers) | **GET** /customers | All customer
*CustomerAddressApi* | [**add_customer_address**](docs/CustomerAddressApi.md#add_customer_address) | **POST** /customer_addresses | 
*CustomerAddressApi* | [**find_customer_address_by_id**](docs/CustomerAddressApi.md#find_customer_address_by_id) | **GET** /customer_addresses/{id} | Find Customer address by ID
*CustomerAddressApi* | [**find_customer_addresses**](docs/CustomerAddressApi.md#find_customer_addresses) | **GET** /customer_addresses | All customer address
...
*ReceivedGoodsApi* | [**add_received_goods**](docs/ReceivedGoodsApi.md#add_received_goods) | **POST** /received_goods | 
*ReceivedGoodsApi* | [**find_received_goods**](docs/ReceivedGoodsApi.md#find_received_goods) | **GET** /received_goods | All received goods
*ReceivedGoodsApi* | [**find_received_goods_by_id**](docs/ReceivedGoodsApi.md#find_received_goods_by_id) | **GET** /received_goods/{id} | Find Received goods by ID
...
*StockImageApi* | [**add_stock_image**](docs/StockImageApi.md#add_stock_image) | **POST** /stock_images | 
*StockImageApi* | [**find_stock_image_by_id**](docs/StockImageApi.md#find_stock_image_by_id) | **GET** /stock_images/{id} | Find Stock image by ID
*StockImageApi* | [**find_stock_images**](docs/StockImageApi.md#find_stock_images) | **GET** /stock_images | All stock image
...
*SupplierApi* | [**add_supplier**](docs/SupplierApi.md#add_supplier) | **POST** /suppliers | 
*SupplierApi* | [**find_supplier_by_id**](docs/SupplierApi.md#find_supplier_by_id) | **GET** /suppliers/{id} | Find Supplier by ID
*SupplierApi* | [**find_suppliers**](docs/SupplierApi.md#find_suppliers) | **GET** /suppliers | All supplier
*SupplierAddressApi* | [**add_supplier_address**](docs/SupplierAddressApi.md#add_supplier_address) | **POST** /supplier_addresses | 
*SupplierAddressApi* | [**find_supplier_address_by_id**](docs/SupplierAddressApi.md#find_supplier_address_by_id) | **GET** /supplier_addresses/{id} | Find Supplier address by ID
*SupplierAddressApi* | [**find_supplier_addresses**](docs/SupplierAddressApi.md#find_supplier_addresses) | **GET** /supplier_addresses | All supplier address
...
*WorkCentreApi* | [**add_work_centre**](docs/WorkCentreApi.md#add_work_centre) | **POST** /work_centres | 
...
*WorkCentreApi* | [**find_work_centres**](docs/WorkCentreApi.md#find_work_centres) | **GET** /work_centres | All work centre
*WorkCentreGroupApi* | [**add_work_centre_group**](docs/WorkCentreGroupApi.md#add_work_centre_group) | **POST** /work_centre_groups | 
