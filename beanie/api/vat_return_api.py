...
class VatReturnApi(object):
    ...
    def find_vat_returns(self, **kwargs):  # noqa: E501
        """All vat return  # noqa: E501

        Returns all vat return from the system that the user has access to  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.find_vat_returns(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.find_vat_returns_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.find_vat_returns_with_http_info(**kwargs)  # noqa: E501
            return data

    def find_vat_returns_with_http_info(self, **kwargs):  # noqa: E501
        """All vat return  # noqa: E501

        Returns all vat return from the system that the user has access to  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.find_vat_returns_with_http_info(async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_vat_returns" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[VatReturn]',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
